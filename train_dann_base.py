...
from trainer.uda_trainer import UDA_trainer
...
def get_argparser():
    ...
    parser.add_argument("--name", type=str, default='base_dann')
...
def main():
    ...
    Log.init(logfile_level="info",
             stdout_level="info",
             log_file="guorongxiao/EEG_Video_Fusion/log/base_bann_eeg_0814_2.log",
    ...
    trainer = UDA_trainer(model, daloss, optimizer, loss_fn, metric, src_loader, tgt_loader, test_loader, args, weights_for_each_class)
    trainer.train()
    trainer.test()
