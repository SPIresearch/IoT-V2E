...
class MultiHeadedAttention(nn.Module):
    def __init__(self, h, d_model, afr_reduced_cnn_size, dropout=0.1):
        ...
        # self.convs = clones(CausalConv1d(afr_reduced_cnn_size, afr_reduced_cnn_size, kernel_size=7, stride=1), 2)
...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x_in):
        ...
        x = self.sublayer_output0(query, lambda x: self.self_attn(query, x_in, x_in))  # Encoder self-attention
        return self.sublayer_output1(x, self.feed_forward)
